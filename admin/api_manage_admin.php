...
// total records
$totalRes = $conn->query("SELECT COUNT(*) AS cnt FROM user WHERE role = 'admin'");
...
while ($r = $res->fetch_assoc()) {
    $actions = '<a href="edit_admin.php?id=' . urlencode($r['id_user']) . '" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a> ';
    $actions .= '<a href="delete_admin.php?id=' . urlencode($r['id_user']) . '" class="btn btn-sm btn-danger" onclick="return confirm(\'Hapus admin ini?\')"><i class="fa fa-trash"></i></a>';
